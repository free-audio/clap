...
typedef struct clap_vst3_converter {
   ...
   // [main-thread]
   CLAP_NODISCARD bool (*convert_state)(const struct clap_vst3_converter *converter,
   ...
   // [thread-safe]
   CLAP_NODISCARD bool (*convert_normalized_value)(const struct clap_vst3_converter *converter,
   ...
   // [thread-safe]
   CLAP_NODISCARD bool (*convert_plain_value)(const struct clap_vst3_converter *converter,
                                              uint32_t                          vst3_param_id,
...
typedef struct clap_vst3_converter_factory {
   ...
   CLAP_NODISCARD uint32_t (*count)(const struct clap_vst3_converter_factory *factory);

   // Get the converter at the given index
   CLAP_NODISCARD const
      clap_vst3_converter_t *(*get)(const struct clap_vst3_converter_factory *factory,
                                    uint32_t                                  index);
